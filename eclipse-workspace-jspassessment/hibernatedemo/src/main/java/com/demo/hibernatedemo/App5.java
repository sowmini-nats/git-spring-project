...
public class App5 {
	public static void main(String[] args) {
		SessionFactory sessionFactory=HibernateUtility.getSessionFactoryObject();
		 ...
		 session.persist(prd1);
		 session.persist(prd2);
		 System.out.println("Product created with id :" + prd1.getPrdId());
		 System.out.println("Product created with id :" + prd2.getPrdId());
		 trnx.commit();
		 session.close();
	}
}
