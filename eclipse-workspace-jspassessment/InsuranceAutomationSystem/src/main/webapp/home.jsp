...
body {
    background-image:url('https://automationhero.ai/wp-content/uploads/2019/05/insurance-automation.jpg'); /* Add the path to your image */
...
<div class="container">
 ...
 <%if(session.getAttribute("role")!=null){
  ...
  <div class="style">
  	<a href="/home">Home</a>
    <a href="/manager-customer-detail">Customers & Policies</a>
    <a href="/agent-detail-all">Agents</a>
    <a href="/premium-calculator">Premium Calculator</a>
    <a href="/logout">Logout</a>
  </div>
  <%}else if(session.getAttribute("role").toString().equals("Customer")){%>
    ...
    <a href="/customer/policy">View Policy</a>
    <a href="/premium-calculator">Premium Calculator</a>
    <a href="/logout">Logout</a>
  </div>
  <%}else if(session.getAttribute("role").toString().equals("Admin")){%>
    <div class="style">
  	<a href="/home">Home</a>
    <a href="/admin/customer-list">Customers</a>
    <a href="/admin/agent-list">Agents</a>
    <a href="/admin/policy-list">Policies</a>
    <a href="/logout">Logout</a>
  </div>
	<% }}else{ %>
  <div class="style">
