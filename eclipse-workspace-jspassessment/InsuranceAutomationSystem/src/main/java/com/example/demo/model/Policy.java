...
public class Policy {
	...
	public Policy(int policyId, String policyName, int coverageAmt, double premiumAmt, int policyTerm,
			String effectiveDate, String paymentFrequency, String beneficiaryName, Customer customer,
	...
	public Policy(String policyName, int coverageAmt, double premiumAmt, int policyTerm, String effectiveDate, String paymentFrequency, String beneficiaryName, Customer customer, String policyStatus,
			String policyAddOns) {
		super();
		this.policyName = policyName;
		this.coverageAmt = coverageAmt;
	...
	public String toString() {
		return "Policy [policyId=" + policyId + ", policyName=" + policyName + ", coverageAmt=" + coverageAmt
				...
				+ ", paymentFrequency=" + paymentFrequency + ", beneficiaryName="
