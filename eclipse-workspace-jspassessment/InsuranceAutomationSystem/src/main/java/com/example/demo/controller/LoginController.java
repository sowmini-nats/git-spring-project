...
public class LoginController {
	...
	@PostMapping("/login")
	public String loginValidation(int userId,String password,String path,HttpServletRequest request) {
		String value = service.validateUser(userId, password,path,request);
